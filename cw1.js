let livro_cw1 ={
  ...
  visaogeral:{
      ...
      cenas:[				
        {ordem:1,
        predecessor:0,
        texto:'OLÁ, SEJAM BEM VINDOS AO MÓDULO CW1 DA DISCIPLINA MUNDO COMPUTACIONAL!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:4,
        predecessor:3,
        texto:'NESTE MÓDULO, VAMOS APRENDER SOBRE VÁRIAS COISAS: ENTRE ELAS OS ALGORITMOS, CONDICIONAIS E LAÇOS.',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:5,
        predecessor:4,
        texto:'COM ISSO, PODEMOS PROGRAMAR ROBÔS E COMPUTADORES PARA RESOLVER PROBLEMAS DE UM JEITO INOVADOR E CRIATIVO.',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:6,
        predecessor:5,
        texto:'E SABE O QUE É MAIS LEGAL? TODO O NOSSO APRENDIZADO SERÁ DE FORMA PRÁTICA E DIVERTIDA!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:7,
        predecessor:6,
        texto:'VOCÊS VÃO VER COMO É DIVERTIDO PROGRAMAR E RESOLVER DESAFIOS!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:8,
        predecessor:7,
        texto:'DURANTE ESSA JORNADA, VOCÊS VÃO DESENVOLVER HABILIDADES SUPER IMPORTANTES, COMO ANÁLISE E DECOMPOSIÇÃO DE PROBLEMAS, IDENTIFICAÇÃO DE PADRÕES E PENSAMENTO ALGORÍTMICO.',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:9,
        predecessor:8,
        texto:'ESSAS HABILIDADES SÃO FUNDAMENTAIS PARA ENFRENTAR DESAFIOS, TANTO AGORA QUANTO NO FUTURO!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:10,
        predecessor:9,
        texto:'PREPAREM-SE PARA SE DIVERTIR E APRENDER MUITO!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
        ...
        {ordem:11,
        predecessor:10,
        texto:'VAMOS JUNTOS EXPLORAR O INCRÍVEL MUNDO COMPUTACIONAL!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'',
        textoImpresso:0,
...
/* conteudo */
  unidade1:{
	  ...
	  licao1:{id:'CW1AULA01CODE',
		...
		estiloPadrao:'basicoPaisagem',
			cenas:[				
				{ordem:1,
				predecessor:0,
        texto:'OS <b>ALGORITMOS</b> ESTÃO AO NOSSO REDOR, CONTROLANDO MÁQUINAS MODERNAS QUE USAMOS NO DIA A DIA.',
				urlAudioTexto:'',
        ...
        promptImagem:'crie uma imagem de uma garotinha escovando os dentes',
        imagemImpresso:1,
        ...
        promptImagem:'crie uma imagem de um garotinho seguindo os passos para dobrar uma camisa',
        imagemImpresso:1,
        imagemFonte:'dall-e 3',
        textoDescritivoImagem:'',},
        ...
        textoImpresso:1,
        textoImpressoRecriado:'ALGORITMOS SERVEM PARA DIVIDIR PROBLEMAS GRANDES.',
    ...
    estiloPadrao:'basicoPaisagem',
      cenas:[				
        ...
        textoImpresso:1,
        textoImpressoRecriado:'ELE CONSEGUE CONTAR MUITO RÁPIDO, PODEMOS USAR PARA DESENHAR, TOCAR MÚSICAS... E ATÉ PARA CONVERSAR COM NOSSOS AMIGOS QUE ESTÃO LONGE.',
        ...
        {ordem:7,
        predecessor:6,
        texto:'A <b>TORRE</b>, OU <b>CPU</b>, ONDE ESTÁ O PROCESSADOR, É COMO SE FOSSE O CÉREBRO DO COMPUTADOR. ELE FAZ CÁLCULOS MUITO RAPIDAMENTE.',
        urlAudioTexto:'',
        textoSimplificado:'',
        ...
        {ordem:8,
        predecessor:7,
        texto:'O <b>MONITOR</b> É A TELA ONDE PODEMOS VER TODAS AS COISAS QUE O COMPUTADOR MOSTRA PARA NÓS. PODEMOS VER DESENHOS, ASSISTIR A VÍDEOS E JOGAR JOGOS DIVERTIDOS!',
        urlAudioTexto:'',
        textoSimplificado:'',
        ...
        {ordem:10,
        predecessor:9,
        texto:'E POR FIM USAMOS O <b>MOUSE</b>, PARA APONTAR E CLICAR NAS COISAS QUE QUEREMOS NO COMPUTADOR. COM ELE, PODEMOS DESENHAR, SELECIONAR COISAS E ATÉ BRINCAR EM JOGOS!',
        urlAudioTexto:'',
        textoSimplificado:'',
        ...
        {ordem:12,
        predecessor:11,
        texto:'OS <b>COMPUTADORES DE MESA</b> SÃO USADOS EM ESCOLAS, LOCAIS DE TRABALHO OU EM CASA. ELES NOS AJUDAM A FAZER LIÇÃO DE CASA, JOGAR JOGOS E ASSISTIR A FILMES!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i2-computador/img14.jpg',
        textoImpresso:1,
        textoImpressoRecriado:'COMPUTADORES DE MESA: SÃO OS QUE FICAM EM CASA.',
        ...
        {ordem:13,
        predecessor:12,
        texto:'OS <b>LAPTOPS</b> SÃO OS COMPUTADORES DE MESA, MAS SÃO PORTÁTEIS, OU SEJA, PODEMOS LEVÁ-LOS PARA ONDE QUISERMOS. PODEMOS USÁ-LOS PARA FAZER TRABALHOS NA ESCOLA, ASSISTIR A VÍDEOS OU ATÉ MESMO JOGAR JOGUINHOS QUANDO ESTAMOS VIAJANDO!',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i2-computador/img15.jpg',
        textoImpresso:1,
        textoImpressoRecriado:'LAPTOPS: SÃO COMO OS COMPUTADORES DE MESA MAS SÃO PORTÁTEIS, OU SEJA, PODEMOS LEVÁ-LOS CONOSCO.',
        ...
        textoImpresso:1,
        textoImpressoRecriado:'TABLETS: SÃO COMO OS LAPTOPS, PORÉM MAIS LEVES E FÁCEIS DE CARREGAR.',
        ...
        {ordem:15,
        predecessor:14,
        texto:'OS <b>CELULARES</b> SÃO COMO PEQUENOS COMPUTADORES QUE CABEM NO BOLSO! PODEMOS USÁ-LOS PARA LIGAR PARA NOSSOS AMIGOS, TIRAR FOTOS E MUITO MAIS.',
        urlAudioTexto:'',
        textoSimplificado:'',
        ...
        textoImpresso:1,
        textoImpressoRecriado:'TODOS ESSES TIPOS DE COMPUTADORES TORNAM NOSSA VIDA MAIS FÁCIL E DIVERTIDA!',
    ...
    estiloPadrao:'basicoPaisagem',
      cenas:[				
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob1.jpg',
        textoImpresso:0,
        textoImpressoRecriado:'',
        promptImagem:'faça uma imagem de robôs diferentes, com robôs de filmes e outros, com base na imagem enviada',
        imagemImpresso:0,
        imagemFonte:'leonardo',
        textoDescritivoImagem:'',},
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob2.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        promptImagem:'crie uma imagem colorida de uma sala com um robô aspirador em close-up, limpando o chão',
        imagemImpresso:0,
        imagemFonte:'Cogna IA',
        textoDescritivoImagem:'',},
        ...
        {ordem:4,
        predecessor:3,
        texto:'UM ROBÔ É UMA MÁQUINA QUE PODE FAZER COISAS DIFERENTES SEM A AJUDA DIRETA DE UMA PESSOA.',
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob4.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/imag5.jpg',
        textoImpresso:1,
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/imag6.jpg',
        textoImpresso:1,
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob7.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob8.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob9.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/img11.webp',
        textoImpresso:1,
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob12.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        promptImagem:'gere uma imagem de um robô jogando xadrez com uma criança',
        imagemImpresso:0,
        imagemFonte:'Cogna IA',
        textoDescritivoImagem:'',},
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.cloud.google.com/mindmakers/Computational%20World/CW1/i3-robos/img13.webp',
        textoImpresso:1,
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob14.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i3-robos/rob15.png',
        textoImpresso:0,
        textoImpressoRecriado:'',
        promptImagem:'gere uma imagem de robôs diferentes',
        imagemImpresso:0,
      ...
      estiloPadrao:'basicoPaisagem',
        ...
        urlAudioTexto:'',
        textoSimplificado:'',
        urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i4-letropolis/img3.webp',
        textoImpresso:1,
  ...
  unidade2:{
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:1,
      predecessor:0,
      texto:'TEM MUITAS COISAS EM CASA QUE DEPENDEM DE ELETRICIDADE, CERTO?',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i5-circuitos/img3.jpg',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'',
      imagemImpresso:0,
      ...
      {ordem:8,
      predecessor:7,
      texto:'QUANDO OLHAMOS PARA A BATERIA, VEMOS DOIS LADOS E UM DESSES LADOS TEM UM SÍMBOLO DE MAIS (+). ESTE SÍMBOLO VAI NOS AJUDAR A COLOCAR TODAS AS PARTES DO CIRCUITO NO LUGAR CERTO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:9,
      predecessor:8,
      texto:'E PRECISAMOS TAMBÉM DE UM LED. ELE É COMO SE FOSSE UMA LÂMPADA, QUE VAI ACENDER NO NOSSO CIRCUITO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i5-circuitos/img11.jpeg',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'',
      imagemImpresso:0,
      ...
      {ordem:12,
      predecessor:11,
      texto:'E NUNCA DEVEMOS COLOCAR OBJETOS NA TOMADA OU BRINCAR COM FIOS ELÉTRICOS. ELES PODEM SER PERIGOSOS. DEVEMOS SEMPRE ESTAR EM SEGURANÇA PARA EXPLORAR O MUNDO DA ELETRICIDADE!',
      urlAudioTexto:'',
      textoSimplificado:'',
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      textoImpresso:1,
      textoImpressoRecriado:'EVENTOS PODEM ACONTECER TODO DIA: "O SOL NASCEU".',
      ...
      {ordem:3,
      predecessor:2,
      texto:'UM ARCO-ÍRIS, QUANDO OCORRE, É UM EVENTO INESPERADO QUE NOS FAZ REAGIR: "NOSSA, QUE LINDO!"',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:4,
      predecessor:3,
      texto:'PROGRAMAS DE COMPUTADORES TAMBÉM ENTENDEM EVENTOS. ELES SÃO PROGRAMADOS PARA REALIZAR AÇÕES QUANDO CERTOS EVENTOS ACONTECEM.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i7-eventos/img6.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'gere uma imagem, em estilo revista em quadrinhos, colorida, de uma criança jogando videogame',
      imagemImpresso:0,
      imagemFonte:'Cogna IA',
      textoDescritivoImagem:'',},
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i7-eventos/img11.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i8-numeropolis/img4.webp',
      textoImpresso:1,
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i8-numeropolis/num6.jpeg',
      textoImpresso:1,
      textoImpressoRecriado:'',
  ...
  unidade3:{
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:3,
      predecessor:2,
      texto:'ELA ESTABELECEU UMA CONDICIONAL</b>: <code><b>SE</b> VOCÊ FEZ O DEVER DE CASA <br/>&nbsp;&nbsp;<b>ENTÃO</b> VOCÊ PODE VER O FILME E COMER PIPOCA</code>',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:4,
      predecessor:3,
      texto:'ESSA CONDICIONAL MOSTRA EXATAMENTE O QUE É PRECISO PARA VER O FILME E COMER PIPOCA. É COMO UMA REGRA QUE NOS GUIA!',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i9-condicionais/cond5.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'gere uma imagem em estilo de pintura a óleo que mostre uma criança negra fazendo o dever de casa, sentada à uma mesa',
      imagemImpresso:0,
      imagemFonte:'Cogna IA',
      textoDescritivoImagem:'',},
      ...
      {ordem:6,
      predecessor:5,
      texto:'E O MAIS LEGAL É QUE AS CONDICIONAIS TAMBÉM SÃO USADAS NA PROGRAMAÇÃO DE COMPUTADORES!',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i9-condicionais/cond8.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:1,
      predecessor:0,
      texto:'HOJE VAMOS APRENDER SOBRE ALGO MUITO IMPORTANTE CHAMADO DEPURAÇÃO, OU DEBUGGING, EM INGLÊS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:2,
      predecessor:1,
      texto:'UM BUG, DO INGLÊS BICHO, É UM APELIDO PARA PROBLEMAS QUE ACONTECEM EM PROGRAMAS DE COMPUTADOR.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i10-depuracao/dep3.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'gere uma imagem em tons majoritareamente roxos e rosa de uma detetive humana em frente a um computador que tem um bug robótico saindo da tela',
      imagemImpresso:0,
      imagemFonte:'Cogna IA',
      textoDescritivoImagem:'',},
      ...
      {ordem:4,
      predecessor:3,
      texto:'A DEPURAÇÃO , OU DEBUG EM INGLÊS, É QUANDO PROCURAMOS OS ERROS, OU BUGS, EM PROGRAMAS. QUANDO INVESTIGAMOS ALGO, PROCURANDO POR ERROS, PODEMOS DIZER QUE FAZEMOS UMA DEPURAÇÃO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:5,
      predecessor:4,
      texto:'É MUITO DIFÍCIL FAZER UM PROGRAMA CERTO LOGO NA PRIMEIRA VEZ, É COMUM SURGIREM BUGS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:6,
      predecessor:5,
      texto:'POR ISSO, OS PROGRAMADORES ESTÃO MUITO ACOSTUMADOS A USAR A DEPURAÇÃO. ELES TAMBÉM COSTUMAM FAZER ESSE PROCESSO EM PARES, PARA QUE NINGUÉM FIQUE CANSADO, FAZENDO UMA COISA SÓ O TEMPO TODO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i10-depuracao/img12.webp',
      textoImpresso:1,
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i10-depuracao/dep9.png',
      textoImpresso:0,
      textoImpressoRecriado:'',
      promptImagem:'gere uma imagem em tons majoritareamente rosa de um detetive humano olhando para o espectador pela lupa em um fundo tecnológico',
      imagemImpresso:0,
      imagemFonte:'Cogna IA',
      textoDescritivoImagem:'',},
    ]}},
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:1,
      predecessor:0,
      texto:'HOJE VAMOS VOLTAR A LETRÓPOLIS, A CIDADE DOS ROBÔS QUE GOSTAM DE LETRAS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i4-letropolis/img2.jpg',
      textoImpresso:1,
      ...
      textoImpresso:1,
      textoImpressoRecriado:'VAI COMEÇAR A SUPER COMPETIÇÃO PARA SABER QUAL ROBÔ TEM A MELHOR PROGRAMAÇÃO PARA ESPORTES DA NEVE.',
      promptImagem:'robô 3d engraçado esquiando em uma montanha nevada, fazendo movimentos de zigue zague',
      imagemImpresso:1,
      imagemFonte:'ideogram',
      textoDescritivoImagem:'',},
  ...
  unidade4:{
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:2,
      predecessor:1,
      texto:'EXISTEM MANEIRAS DE PROTEGER NOSSAS INFORMAÇÕES E MANTER NOSSOS DISPOSITIVOS SEGUROS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:7,
      predecessor:6,
      texto:'E ASSIM COMO USAMOS UMA CHAVE PARA TRANCAR UMA PORTA, USAMOS UMA SENHA PARA "TRANCAR" NOSSOS DISPOSITIVOS E CONTAS PARA QUE APENAS NÓS POSSAMOS ACESSÁ-LOS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:8,
      predecessor:7,
      texto:'POR ISSO, AS SENHAS SEMPRE DEVEM SER “FORTES”, OU SEJA, A SENHA DEVE SER ÚNICA E NÃO DEVEMOS USAR A MESMA SENHA PARA TUDO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:9,
      predecessor:8,
      texto:'QUANTO MAIS DIFERENTE A SENHA, MAIS DIFÍCIL SERÁ PARA ALGUÉM DESCOBRI-LA.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:10,
      predecessor:9,
      texto:'ASSIM COMO NÃO EMPRESTAMOS A CHAVE DE CASA PARA QUALQUER PESSOA, NÃO DEVEMOS COMPARTILHAR SENHAS COM NINGUÉM, ALÉM DE NOSSOS PAIS OU RESPONSÁVEIS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:11,
      predecessor:10,
      texto:'MANTER A SENHA EM SEGREDO É UMA MANEIRA IMPORTANTE DE PROTEGER INFORMAÇÕES PESSOAIS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:12,
      predecessor:11,
      texto:'ALÉM DAS SENHAS, É IMPORTANTE MANTER OS DISPOSITIVOS PROTEGIDOS. ISSO SIGNIFICA NÃO OS DEIXAR DESBLOQUEADOS OU SEM SUPERVISÃO PARA QUE OUTRAS PESSOAS NÃO POSSAM ACESSÁ-LOS SEM PERMISSÃO.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      {ordem:13,
      predecessor:12,
      texto:'E SE RECEBERMOS MENSAGENS ESTRANHAS, PEDINDO SENHAS OU INFORMAÇÕES PESSOAIS, NUNCA DEVEMOS RESPONDER OU ABRIR, PODE SER PERIGOSO.',
      urlAudioTexto:'',
      textoSimplificado:'',
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:5,
      predecessor:4,
      texto:'OU AS DUAS USAM NÚMEROS; OU USAM LETRAS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i13-numerxletr/img7.webp',
      textoImpresso:1,
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i13-numerxletr/img8.webp',
      textoImpresso:1,
    ...
    estiloPadrao:'basicoPaisagem',
      ...
      {ordem:2,
      predecessor:1,
      texto:'BINARÓPOLIS FICA PRÓXIMO A NUMERÓPOLIS. E LÁ TAMBÉM VIVEM APENAS ROBÔS.',
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'',
      textoImpresso:0,
      ...
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i14-binaropolis/img3.webp',
      textoImpresso:1,
      ...
      {ordem:9,
      predecessor:8,
      texto:'MAS SE BINARÓPOLIS TEM CINCO RUAS, COMO PODEREMOS DAR NOMES DIFERENTES PARA CADA RUA?',
      urlAudioTexto:'',
      textoSimplificado:'',
      urlImagem:'https://storage.googleapis.com/mindmakers/Computational%20World/CW1/i14-binaropolis/img6.jpg',
      textoImpresso:1,
      textoImpressoRecriado:'MAS COMO PODEREMOS NOMEAR CINCO RUAS COM DOIS SÍMBOLOS?',
      ...
      {ordem:11,
      predecessor:10,
      texto:'VAMOS APRENDER UM POUCO SOBRE ESSE CÓDIGO MISTERIOSO PARA AJUDAR BINARÓPOLIS.',
      urlAudioTexto:'',
      textoSimplificado:'',
