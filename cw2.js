  ...
  visaogeral:{
    ...
    unidade1:{
      ...
      licao5:{
        ...
        infografico:{titulo:'Robô Sphero: Descobrindo o Mundo dos Robôs',
        tituloSimplificado:'Robô Sphero',
        estiloPadrao:'basicoPaisagem',
        /** urlVideo:'',
        urlPodcast:'', **/
        cenas:[
          {ordem:1,
          predecessor:0,
          texto:'Você já viu robôs em filmes e jogos, certo? Eles podem ter pernas, rodas ou até mesmo se parecer com humanos. Mas você sabe como eles surgiram?',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:3,
          predecessor:2,
          texto:'Antigamente, para mudar o movimento de um autômato, os inventores precisavam reconstruir muitas partes.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:4,
          predecessor:3,
          texto:'No entanto, hoje, com robôs modernos, basta alterar programas de computador para modificar seus movimentos, que podem ser bem sofisticados.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:5,
          predecessor:4,
          texto:'Existem muitos tipos de robôs, usados para várias finalidades. Por exemplo, os robôs industriais são usados para tarefas como montar carros, empacotar produtos e até mesmo ajudar em cirurgias.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:6,
          predecessor:5,
          texto:'Outros robôs exploram lugares onde humanos não podem ir, como planetas e luas. E você? Está pronto para explorar o mundo dos robôs?',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:7,
          predecessor:6,
          texto:'No nosso curso, você vai programar robôs, começando com o Sphero, um pequeno robô esférico que se move como o BB-8 de Star Wars.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:8,
          predecessor:7,
          texto:'Você aprenderá a fazer o Sphero se mover, mudar de direção, velocidade ou de cor.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:9,
          predecessor:8,
          texto:'Além disso, você usará o Sphero para resolver desafios, explorando um pouco de mecânica e eletrônica para criar projetos criativos.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:10,
          predecessor:9,
          texto:'Com mecânica, você vai construir peças para o Sphero, como carrocerias e partes móveis. E, com eletrônica, você vai adicionar circuitos para fazer o Sphero reagir a sons ou obstáculos, por exemplo.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:11,
          predecessor:10,
          texto:'Bem-vindo ao mundo dos robôs, onde você será o inventor!',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
        ...
        cenas:[
          ...
          textoImpresso:1,
          imagemImpresso:1,
          urlImagem:'Mas sempre podemos melhorar! Que tal criar um taxibot totalmente robotizado que funcione só com programação? Use seu talento e imaginação!',
          promptImagem:'', 
          imagemFonte:'',
          textoDescritivoImagem:'',},
    ...
    unidade2:{
      ...
      licao9:{
        ...
        urlPodcast:'', **/
         cenas:[
          ...
          {ordem:4,
          predecessor:3,
          texto:'Essas condições não são apenas para nós; são usadas em algoritmos, programas de computador e circuitos eletrônicos.',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpressoRecriado:'Essas condições não são apenas para nós; são usadas em algoritmos, programas de computador e circuitos eletrônicos. Por exemplo, os sinais de carro e pedestre estão conectados eletronicamente para garantir que nunca tenham a mesma cor.',
          textoImpresso:1,
          imagemImpresso:1,
          urlImagem:'',
          promptImagem:'', 
          ...
          {ordem:6,
          predecessor:5,
          texto:'Usamos <b>Se</b>, <b>Então</b> e <b>Senão</b> em algoritmos, chamando essa estrutura de Expressão Condicional. Um exemplo: <p><code><b>se</b> sinal = vermelho <br/>&nbsp;&nbsp;&nbsp;então pare<br/><br/><b>se</b> sinal = verde <br/>&nbsp;&nbsp;&nbsp;então prossiga</code>',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
          ...
          {ordem:8,
          predecessor:7,
          texto:'E o sinal amarelo? Isso é assunto para outra lição... Por enquanto, pratique bastante a programação com condicionais!',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
      ...
      licao11:{
        ...
        cenas:[
          ...
          {ordem:8,
          predecessor:7,
          texto:'Se conectarmos um tipo de biga ao robô, podemos inventar uma biga-robô! Solte sua imaginação e crie uma biga robotizada!',
          urlAudioTexto:'',
          textoSimplificado:'',
          textoImpresso:1,
          imagemImpresso:1,
