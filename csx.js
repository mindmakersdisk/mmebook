    ...
    unidade3:{
      ...
      licao16:{
        ...
        cenas:[				
          ...
          {ordem:5,
          predecessor:4,
          texto:'Além das portas lógicas AND e OR, componentes de circuito eletrônico equivalentes às expressões lógicas "E" e "OU", também existe a porta lógica NOT, equivalente à expressão lógica "NÃO".',
          urlAudioTexto:'',
          ...
          {ordem:6,
          predecessor:5,
          texto:'Além destas, existem outras portas lógicas um pouco mais sofisticadas, que simplificam a construção de circuitos eletrônicos mais complexos ou incomuns, como as portas NAND (<b>NÃO E</b>), NOR (<b>NÃO OU</b>), XOR (<b>OU EXCLUSIVO</b>) e XNOR (<b>NÃO OU EXCLUSIVO</b>), que conheceremos em etapas mais avançadas do curso.',
          urlAudioTexto:'',
          ...
          {ordem:8,
          predecessor:7,
          texto:'Quando analisamos portas lógicas, utilizamos o dígito, também chamado bit, 1 (um) para representar verdadeiro/energizado; e o dígito ou bit 0 (zero) para representar falso/desligado. Uma porta de entrada com bit 1 indica condição verdadeiro; e com bit 0 a condição falso.',
          urlAudioTexto:'',
          ...
          {ordem:9,
          predecessor:8,
          texto:'Assim como as condicionais melhoraram a capacidade de nossos programas, as portas lógicas trazem muito mais inteligência aos aparelhos eletrônicos que usamos em nosso dia à dia.',
          urlAudioTexto:'',
        ...
        licao17:{
          ...
          cenas:[				
            {ordem:1,
            predecessor:0,
            texto:'Os dados são o novo petróleo!" Esta célebre afirmação de Clive Humby, um matemático britânico, destaca o valor crescente dos dados em nossa era digital.',
            urlAudioTexto:'',
            ...
            {ordem:6,
            predecessor:5,
            texto:'Os dados possuem <b>tipos</b> específicos, que delimitam os valores que podem assumir. Por exemplo, dados do tipo "inteiro" aceitam somente valores como 1, 2 e -5. Já os dados do tipo "decimal" admitem números com frações como 1,5 ou 5,75, essenciais para trabalharmos com medidas, como o peso de um objeto.',
            urlAudioTexto:'',
            textoSimplificado:'TODO',
            textoImpresso:1,
            imagemImpresso:1,
      ...
      licao20:{		  
        ...
        cenas:[				
          ...
          {ordem:2,
          predecessor:1,
          texto:'Vamos agora entender como os computadores usam o sistema binário para armazenar e processar números.',
          urlAudioTexto:'',
          ...
          {ordem:4,
          predecessor:3,
          texto:'Já os computadores adotam o sistema binário, que usa dois dígitos, mas que também é capaz de representar qualquer valor numérico. No sistema binário, cada posição à esquerda tem o dobro do valor. Com isso os números binários ficam bem maiores que os decimais, mas isso não é um problema para os computadores!',
          urlAudioTexto:'',
          ...
          {ordem:6,
          predecessor:5,
          texto:'O sistema binário é mesmo como um "código secreto" - aqueles que o dominam foram capazes conceber os computadores no passado, e de se comunicar de uma maneira indecifrável para os não iniciados.',
          urlAudioTexto:'',
