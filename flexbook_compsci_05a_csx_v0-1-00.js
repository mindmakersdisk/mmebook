let livro_csx ={
  ...
  unidade1:{
	  ...
	  licao1:{
          ...
          {ordem:12,
          predecessor:11,
          texto:'Nos últimos anos, os criativos fabricantes conseguiram juntar todas as partes do computador de mesa em um só aparelho, pequeno o suficiente para carregar conosco, são os celulares e tablets, também conhecidos como computadores móveis. As possibilidades são infinitas.',
		  ...
		  textoImpresso:1,
		  imagemImpresso:1,
		  textoImpressoRecriado:'Além dessas quatro partes básicas, o computador pode estar ligado a muitos outros tipos de dispositivos como caixas de som, impressoras, joysticks, simuladores de instrumentos musicais, entre outros. <p>As possibilidades são infinitas. <p>Nos últimos anos, os criativos fabricantes conseguiram juntar todas as partes do computador de mesa em um só aparelho, pequeno o suficiente para carregar conosco, são os celulares e tablets, também conhecidos como computadores móveis. <p>As possibilidades são infinitas.',
...
//	  licao2:{},
	  ...
	  licao2:{
          ...
          {ordem:7,
          predecessor:6,
          texto:'O condutor transmite a energia em circuito fechado. Os fios são condutores.',
          urlAudioTexto:'',
          ...
          {ordem:11,
          predecessor:10,
          texto:'Importante, não? Aprender circuitos elétricos vai ser um grande passo para liberar aquele cientista criativo que existe dentro de você.',
          urlAudioTexto:'',
      ...
      licao5:{
		  ...
		  {ordem:1,
		  predecessor:0,
		  texto:'Expressões Condicionais. Já percebeu quantas decisões você tem que tomar em um dia comum de sua vida? Usar a camiseta branca ou preta, estudar primeiro e depois brincar, jogar vôlei ou futebol. Você decide o que fazer verificando condições. Por exemplo, se eu costumo ir a pé para a escola e está chovendo, então eu levarei um guarda-chuva, senão não será necessário levá-lo. Note que as expressões Se, Então e Senão são condicionantes.',
		  urlAudioTexto:'',
