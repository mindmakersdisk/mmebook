  ...
  unidade4:{
    ...
    licao22:{
      ...
      cenas:[				
       /* {ordem:1,
        ...
        {ordem:5,
        predecessor:4,
        texto:'3. Seja um detetive digital: Muitas vezes, você encontra informações contraditórias na internet, ainda que verdadeiras. Aprenda a investigar diferentes fontes para entender os vários pontos de vista e formar sua própria opinião sobre um assunto.',
        urlAudioTexto:'',
        ...
        {ordem:6,
        predecessor:5,
        texto:'4. Descubra e não repasse notícias falsas: Fake news, ou notícias falsas, se espalham rapidamente no mundo online. Sempre verifique a fonte e a veracidade de tudo que recebe, antes de repassar para outros - não contribua com a disseminação de boatos!',
        urlAudioTexto:'',
        ...
        {ordem:7,
        predecessor:6,
        texto:'A ética digital é a chave para você ser respeitado e bem sucedido no mundo hiperconectado em que vivemos!',
        urlAudioTexto:'',
    ...
    licao25:{		  
      ...
      cenas:[				
        ...
        {ordem:20,
        predecessor:19,
        texto:'De tempos em tempos, lembre-se de salvar suas modificações!<p>Explore livremente esses e muitos outros recursos do Story Lab... e então solte sua criatividade!',  
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
    ...
    licao27:{		  
      ...
      cenas:[				
        ...
        {ordem:5,
        predecessor:4,
        texto:'Por exemplo, podemos programar personagens de jogos para reagir às mudanças de estações, do clima, ou para executar uma determinada rotina todo domingo. Ou simular a transição para um clima chuvoso para testar se um novo sistema de irrigação reage corretamente, desligando antes de submetê-lo ao teste na natureza.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        //textoImpressoRecriado:'Devido à sua importância, simular esses eventos naturais no mundo computacional é muito útil!<p>Por exemplo, podemos programar personagens de jogos, para reagir às mudanças de estações, do clima, ou para executar uma determinada rotina todo domingo.',
        textoImpresso:1,
        imagemImpresso:1,
