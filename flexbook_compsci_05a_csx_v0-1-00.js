  ...
  unidade1:{
    ...
    licao6:{
        ...
        textoSimplificado:'Algoritmo de Trânsito',
	      textoImpresso:1,
        imagemImpresso:1,
		    urlImagem:'https://storage.googleapis.com/mindmakers/cpsciimageinf/CSX/ExprCond/img_5ono-kosuki-5647228_pexels.jpg',
...
=======
        ...
        promptImagem:'TODO', 
        textoDescritivoImagem:'TODO.', },
>>>>>>> 6d4ff0ae6d294b72f060310c363b385dd2bf8479
...
=======
        ...
        /*{ordem:1,
        predecessor:0,        
        texto:'Você já está familiarizado com os diferentes papéis desempenhados pelos componentes eletrônicos de energia, controle e atuação nos circuitos. Além disso, já sabe que os computadores funcionam com códigos binários, formados por sequências de números zeros e uns, também conhecidos como bits.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:2,
        predecessor:1,
        texto:'No sistema binário, o bit 0 é usado para indicar que um componente eletrônico está desligado, enquanto o bit 1 indica que está ligado.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:3,
        predecessor:2,
        texto:'Você também já está familiarizado com o uso de condicionais e expressões lógicas em programação. Por exemplo, o operador lógico "E" (AND) é usado ativar algo somente quando duas condições são atendidas, enquanto o operador lógico "OU" (OR) é usado para ativar algo quando pelo menos uma das condições ocorre.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:4,
        predecessor:3,
        texto:'Ao interpretar uma expressão condicional, os computadores consideram 1 como o resultado de uma expressão verdadeira e 0 como um resultado falso. Por exemplo: ao interpretar a seguinte expressão, se estiver chovendo, o computador retorna 1 para indicar que é verdadeiro.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:5,
        predecessor:4,
        texto:'Agora, é hora de conhecer uma nova categoria de componentes eletrônicos: as portas lógicas. Elas nos permitem criar condicionais utilizando a linguagem dos circuitos eletrônicos, de maneira similar ao sistema binário.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:7,
        predecessor:6,
        texto:'Mas há outras portas que simplificam a criação de circuitos, incorporando uma ou mais portas básicas em um único componente. Essas portas incluem NAND ("NÃO E"), NOR ("NÃO OU"), XOR ("OU EXCLUSIVO") e XNOR ("NÃO OU EXCLUSIVO").',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:8,
        predecessor:7,
        texto:'Circuitos com portas lógicas podem ter várias entradas, mas sempre geram uma única saída.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:9,
        predecessor:8,
        texto:'Para analisar e registrar o comportamento de cada porta lógica, utilizamos tabelas chamadas "tabelas verdade". Nessas tabelas, utilizamos os bits 0 e 1 para ilustrar todas as variações concebíveis dos sinais de entrada, juntamente com o correspondente sinal de saída gerado por uma porta lógica.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:10,
        predecessor:9,
        texto:'As portas lógicas conferem inteligência aos circuitos e estão presentes em muitos dispositivos eletrônicos do dia a dia.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
        ...
        {ordem:11,
        predecessor:10,
        texto:'Agora, é a hora de expandir suas criações, utilizando portas lógicas e explorando novas possibilidades.',
        urlAudioTexto:'',
        textoSimplificado:'TODO',
        textoImpresso:1,
        imagemImpresso:1,
