  ...
  unidade3:{
    ...
    licao16:{
      ...
      cenas:[				
        {ordem:1,
        predecessor:0,
        texto:'Você já conhece diferentes tipos de componentes eletrônicos que desempenham papéis específicos em circuitos, como os de energia, controle e atuação. Além disso, você já aprendeu que os computadores operam com códigos binários, compostos por sequências de números zeros e uns, chamados de bits.',
        urlAudioTexto:'',
    ...
    licao19:{		  
      ...
      cenas:[				
        ...
        {ordem:2,
        predecessor:1,
        texto:'O sistema binário é a chave para transformar números, textos, sons, vídeos... e muito mais em códigos compostos por números 0 e 1.',
        urlAudioTexto:'',
        ...
        {ordem:4,
        predecessor:3,
        texto:'Nessa tabela, cada letra é representada por 8 dígitos, ou seja, 8 símbolos 0 ou 1. Veja como o computador usa a tabela ASCII para armazenar as letras A, C e S, que você digita..',
        urlAudioTexto:'',
    ...
    licao20:{		  
      ...
      cenas:[				
        ...
        {ordem:4,
        predecessor:3,
        texto:'No entanto, os computadores adotam um sistema ainda mais simples: o sistema binário. Nele, apenas dois símbolos, o zero e o um, são utilizados.<p>Ao escrever um número em sistema binário, cada posição à esquerda vale o dobro da posição à sua direita...',
        urlAudioTexto:'',
